 ...
 * @license MIT
 */class R{constructor(t="buffer"){if(!n.typeList.includes(t)){let e=`Invalid argument '${t}' for output type. Allowed types are:\n`;throw e=e.concat(n.typeList.join(", ")),new TypeError(e)}this.base1=new u("default",t),this.base16=new d("default",t),this.base32_crockford=new f("rfc4648",t),this.base32_rfc3548=new f("rfc3548",t),this.base32_rfc4648=new f("rfc4648",t),this.base32_zbase32=new f("zbase32",t),this.base58=new p("default",t),this.base58_bitcoin=new p("bitcoin",t),this.base58_flickr=new p("flickr",t),this.base64=new g("default",t),this.base64_urlsafe=new g("urlsafe",t),this.uuencode=new b("default",t),this.xxencode=new b("xx",t),this.base85_adobe=new w("adobe",t),this.base85_ascii=new w("ascii85",t),this.base85_z85=new w("z85",t),this.base91=new v("default",t),this.leb128=new E("default",t),this.ecoji_v1=new A("emojis_v1",t),this.ecoji_v2=new A("emojis_v2",t),this.base2048=new x("default",t),this.basePhi=new H("default",t),this.byteConverter=new L(t),this.simpleBase={};for(let e=2;e<=62;e++)this.simpleBase[`base${e}`]=new T(e,t)}}
/**
 ...
 * @author UmamiAppearance [mail@umamiappearance.eu]
 * @license MIT
 */const F=["SHA-1","SHA-256","SHA-384","SHA-512"];let q;void 0!==R&&(q="BaseEx"in R?new R.BaseEx:new R);class G{#d=null;#f=null;#p=null;#g=[];constructor(t="SHA-256"){const e=this.constructor.algorithmsAvailable();if(this.#f=0|[].concat(String(t).match(/[0-9]+/)).at(0),this.#d=`SHA-${this.#f}`,1===this.#f&&(this.#f=160),!e.has(this.#d))throw new TypeError(`Available algorithms are: '${F.join(", ")}'.`);q&&this.#b()}static baseEx=q;static algorithmsAvailable(){return new Set(F)}static algorithmsGuaranteed(){return this.constructor.algorithmsAvailable()}static async new(t="SHA-256",e=null){const i=new this(t);return null!==e&&await i.update(e),i}get digestSize(){return this.#f/8}get blockSize(){return this.#f>256?128:64}get name(){return this.#d}async copy(){const t=this.#g.length?Uint8Array.from(this.#g):null;return this.constructor.new(this.#d,t)}async update(t,e=!1){if(t instanceof ArrayBuffer)t=new Uint8Array(t);else if(ArrayBuffer.isView(t))t=new Uint8Array(t.buffer);else{if(!q)throw new TypeError("You need BaseEx if you like to digest anything other than byte-like input.");t=q.byteConverter.encode(t,"uint8")}let i;t.byteLength<2e8?(this.#g=e?Array.from(t):this.#g.concat(Array.from(t)),i=Uint8Array.from(this.#g),i.byteLength>5e8&&!this.warned&&(console.warn("The stored input is getting really big. Dependent from your environment this can lead to memory issues."),this.warned=!0)):(console.warn("Input gets too big to safely store it in memory. It will get processed directly and neither stored nor concatenated to previous input. If the operation fails, it is due to memory issues."),i=t),this.#p=await globalThis.crypto.subtle.digest(this.#d,i)}async replace(t){await this.update(t,!0)}digest(){return this.#p}hexdigest(){return this.#p?Array.from(new Uint8Array(this.#p)).map((t=>t.toString(16).padStart(2,"0"))).join(""):null}#b(){const t=(t,e)=>t.splice(t.indexOf(e),1),e=t=>t.charAt(0).toUpperCase().concat(t.slice(1)),i=Object.keys(q);this.basedigest={toSimpleBase:{}},t(i,"base1"),t(i,"byteConverter"),t(i,"simpleBase");for(const t of i)this.basedigest[`to${e(t)}`]=(...e)=>this.#p?q[t].encode(this.#p,...e):null;for(const t in q.simpleBase)this.basedigest.toSimpleBase[e(t)]=(...e)=>this.#p?q.simpleBase[t].encode(this.#p,...e):null;this.basedigest.toBytes=(...t)=>this.#p?q.byteConverter.encode(this.#p,...t):null}}export{G as default};
